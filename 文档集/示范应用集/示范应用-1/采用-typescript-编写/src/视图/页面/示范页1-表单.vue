...
const 诸字典之构建配置总集之列表: Array<范_本应用中一切字典机_形制要求总集_形参准用式<Page示范页1>> = [
    {
        ...
        诸事之应对: {
            构建该字典所有条目之原式 (
                该字典所属字典群之总机, // eslint-disable-line @typescript-eslint/no-unused-vars
                该字典机自身, // eslint-disable-line @typescript-eslint/no-unused-vars
                第三个参数搜集了从该字典机自身的_重建数据_函数传递过来的实参列表 // eslint-disable-line @typescript-eslint/no-unused-vars
...
export default class Page示范页1 extends Vue {
    ...
    private get 字典机_字典甲 (): null | 范_本应用中一切字典机<Page示范页1> { return this.字典总机 && this.字典总机.为.取某字典机('字典甲') }

    /** 【字典乙】故意采用了不同于【字典甲】、【字典丙】的写法。殊途同归。 */
    private get 字典机_字典乙 (): null | 范_本应用中一切字典机<Page示范页1> { return this.字典总机 && this.字典总机.所持.字典机群.其哈希表['字典乙'] }

    private get 字典机_字典丙 (): null | 范_本应用中一切字典机<Page示范页1> { return this.字典总机 && this.字典总机.为.取某字典机('字典丙') }

    private get 当下存在的所有字典机 (): 范_本应用中一切字典机<Page示范页1>[] {
        return [
            this.字典机_字典甲!,
            this.字典机_字典乙!,
            this.字典机_字典丙!,
    ...
    private get 字典条目之视式之列表_字典甲 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典诸条目之视式_其列表('字典甲') }

    /** 【字典乙】故意采用了不同于【字典甲】、【字典丙】的写法。殊途同归。 */
    private get 字典条目之视式之列表_字典乙 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典机_字典乙 ? [] : this.字典机_字典乙.所持.该字典诸条目之视式.其列表 }

    private get 字典条目之视式之列表_字典丙 (): 范_本应用中一切字典之字典条目之视式[] { return !this.字典总机 ? [] : this.字典总机.为.取某字典诸条目之视式_其列表('字典丙') }
    ...
    private 令所有字典重建数据 (某次任务之补充描述?: string): void {
    ...
    private 令已经存在的字典乙重建数据 (某次任务之补充描述?: string): void {
        const { 字典总机 } = this
    ...
    private mounted (): void {
        this.字典总机 = 作一采信机<范_本应用中一切字典之字典条目之原式, 范_本应用中一切字典之字典条目之视式>(
            this,
